...
const PrivacyPage = () => {
    ...
    useEffect(() => {
        async function fetchData() {
          const privacyPage = await axios(
            'https://backend.paddywackgifts.com/public/api/privacy-policy'
          );
    
          setTitle(privacyPage.data.data[0].title)
          setContent(privacyPage.data.data[0].page_content)
        }
    ...
    const handleFormSubmit = e => {
        ...
        setTimeout(() => {
            axios({
                method: 'POST',
                url: 'https://paddywackgifts.com/backend/public/api/privacy-policy/1',
